...
enum zash_status {
    ...
    ZASH_STATUS_UTILS_COPY_FD_CALLOC_FAILED,
    ZASH_STATUS_UTILS_COPY_FD_READ_FAILED,
    ZASH_STATUS_UTILS_COPY_FD_EMPTY_FILE,
    ZASH_STATUS_UTILS_COPY_FD_WRITE_FAILED,

    ZASH_STATUS_UTILS_RUN_IN_NEW_PROCESS_NULL_POINTER,
    ZASH_STATUS_UTILS_RUN_IN_NEW_PROCESS_FORK_FAILD,
    ZASH_STATUS_UTILS_RUN_IN_NEW_PROCESS_WAIT_FAILED,
    ZASH_STATUS_UTILS_RUN_IN_NEW_PROCESS_CHILD_TERMINATED,
    ...
    ZASH_STATUS_DAEMON_BECOME_NEW_PROCESS_FORK_FAILED = 6000,
    ...
    ZASH_STATUS_SOCKET_GET_INTERFACE_IP_IOCTL_FAILED,
    ...
    ZASH_STATUS_SOCKET_ACCEPT_ACCEPT_FAILED,
    ZASH_STATUS_SOCKET_ACCEPT_SERSOCKOPT_FAILED,

    ZASH_STATUS_SOCKET_TCP_CLIENT_NULL_POINTER,
    ZASH_STATUS_SOCKET_TCP_CLIENT_SOCKET_FAILED,

    ZASH_STATUS_CLIENT_CONNECT_TERMINAL_TO_SOCKET_SELECT_FAILED = 8000,

    ZASH_STATUS_CLIENT_RUN_NULL_POINTER,

    ZASH_STARUS_SERVER_COUNT_PORT_KNOCKS_CALLOC_FAILED = 9000,

    ZASH_STATUS_SERVER_GET_ADDRESS_TO_CONNECT_NOT_ENOUGH_DATA_RECEIVED,

    ZASH_STATUS_SERVER_RUN_SHELL_DUP2_STDIN_FAILED,
    ...
    ZASH_MAIN_SERVER_MAIN_INVALID_PARAMETERS = 11000,

    ZASH_MAIN_CLIENT_MAIN_INVALID_PARAMETERS = 12000,
};
