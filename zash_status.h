...
enum zash_status {
    ...
    ZASH_STATUS_SOCKET_BIND_INTERFACE_NULL_POINTER = 7000,
    ZASH_STATUS_SOCKET_BIND_INTERFACE_SETSOCKOPT_FAILED,

    ZASH_STATUS_SOCKET_GET_TCP_SYN_HEADER_NULL_POINTER,
    ...
    ZASH_STATUS_SOCKET_TCP_CLIENT_CONNECT_FAILED,
